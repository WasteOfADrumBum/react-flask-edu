...
def _is_callable_users_only(cls):
    ...
    class _ProtocolMeta(abc.ABCMeta):
        ...
        def __instancecheck__(cls, instance):
            ...
            if ((not getattr(cls, '_is_protocol', False) or
                 _is_callable_users_only(cls)) and
            ...
            def _proto_hook(other):
                ...
                if not getattr(cls, '_is_runtime_protocol', False):
                    ...
                    raise TypeError("Instance and class checks can only be used with"
                                    " @runtime protocols")
                if not _is_callable_users_only(cls):
                    if sys._getframe(2).f_globals['__name__'] in ['abc', 'functools']:
                        return NotImplemented
                    raise TypeError("Protocols with non-method users"
    ...
    class _ProtocolMeta(GenericMeta):
        ...
        def __instancecheck__(self, instance):
            ...
            if ((not getattr(self, '_is_protocol', False) or
                    _is_callable_users_only(self)) and
        ...
        def __subclasscheck__(self, cls):
            ...
            if (self.__dict__.get('_is_runtime_protocol', None) and
                    not _is_callable_users_only(self)):
                if sys._getframe(1).f_globals['__name__'] in ['abc',
                                                              'functools',
                                                              'typing']:
